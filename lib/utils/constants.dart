final String appName = "Question Quiz App";
final String packageName = "com.question.quiz";
...
final List<String> supporatedLocales = ['en', 'hi',];
//
...
final String databaseUrl =
    "https://quiz.rajsquestionapp.in"; //"http://flutterquiz.thewrteam.in"; //
final String baseUrl = databaseUrl + '/Api/';
//
final String jwtKey = '2000';
